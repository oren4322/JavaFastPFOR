 ...
 * and with integrated differential coding (i.e., given a large array, you can
 * segment it and decode just the subarray you need).
 * 
 * The main differences are that we must specify the number of integers we wish
 * to decode as well as the initial value (for differential coding). This
 * information might be stored elsewhere.
 * 
 * 
...
public interface SkippableIntegratedIntegerCODEC {
	 ...
	 * use IntWrapper to pass the values by reference. yaniv oren - deprecated -
	 * do not use directly, but from the IntegratedIntCompressor
	 * 
	 * @param in
	 *            input array
	 * @param inpos
	 ...
	 * @param initvalue
	 *            initial value for the purpose of differential coding, the
	 ...
	 * after read/write. yaniv oren - deprecated - do not use directly, but from
	 * the IntegratedIntCompressor
	 * 
	 * @param in
	 ...
	 * @param num
	 *            number of integers we want to decode, the actual number of
	 *            integers decoded can be less
	 * @param initvalue
	 *            initial value for the purpose of differential coding, the
	 *            value is automatically updated
	 */
