...
public class IntCompressorTest {
	...
	// yaniv oren - test only our compression algorithm
	IntegratedIntCompressor[] iic = { new IntegratedIntCompressor(
			new SkippableIntegratedComposition(new IntegratedBinaryPacking(), new IntegratedVariableByte())) };

	IntCompressor[] ic = { new IntCompressor(new VariableByte()),
